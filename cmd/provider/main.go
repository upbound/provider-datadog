...
func main() {
	...
	logr := logging.NewLogrLogger(zl.WithName("provider-datadog"))
	if *debug {
	...
	o := tjcontroller.Options{
		...
		Provider:              provider,
		SetupFn:               clients.TerraformSetupBuilder(provider.TerraformProvider, provider.TerraformPluginFrameworkProvider),
