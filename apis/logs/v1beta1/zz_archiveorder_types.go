...
type ArchiveOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/logs/v1beta1.Archive
	ArchiveIds []*string `json:"archiveIds,omitempty" tf:"archive_ids,omitempty"`

	// References to Archive in logs to populate archiveIds.
	// +kubebuilder:validation:Optional
	ArchiveIdsRefs []v1.Reference `json:"archiveIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Archive in logs to populate archiveIds.
	// +kubebuilder:validation:Optional
	ArchiveIdsSelector *v1.Selector `json:"archiveIdsSelector,omitempty" tf:"-"`
}
