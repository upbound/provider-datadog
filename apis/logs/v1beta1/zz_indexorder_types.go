...
type IndexOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/logs/v1beta1.Index
	Indexes []*string `json:"indexes,omitempty" tf:"indexes,omitempty"`

	// References to Index in logs to populate indexes.
	// +kubebuilder:validation:Optional
	IndexesRefs []v1.Reference `json:"indexesRefs,omitempty" tf:"-"`

	// Selector for a list of Index in logs to populate indexes.
	// +kubebuilder:validation:Optional
	IndexesSelector *v1.Selector `json:"indexesSelector,omitempty" tf:"-"`
}
