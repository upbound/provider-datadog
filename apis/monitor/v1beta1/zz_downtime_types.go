...
type DowntimeInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/monitor/v1beta1.Monitor
	MonitorID *float64 `json:"monitorId,omitempty" tf:"monitor_id,omitempty"`

	// Reference to a Monitor in monitor to populate monitorId.
	// +kubebuilder:validation:Optional
	MonitorIDRef *v1.Reference `json:"monitorIdRef,omitempty" tf:"-"`

	// Selector for a Monitor in monitor to populate monitorId.
	// +kubebuilder:validation:Optional
	MonitorIDSelector *v1.Selector `json:"monitorIdSelector,omitempty" tf:"-"`
