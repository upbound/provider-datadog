...
func (mg *ServiceAccountApplicationKey) GetTerraformResourceType() string {
	return "datadog_service_account_application_key"
}
...
// LateInitialize this ServiceAccountApplicationKey using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ServiceAccountApplicationKey) LateInitialize(attrs []byte) (bool, error) {
	params := &ServiceAccountApplicationKeyParameters{}
