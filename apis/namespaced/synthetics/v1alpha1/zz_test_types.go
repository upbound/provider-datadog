...
type AssertionInitParameters struct {
	...
	// (Block List, Max: 1) Expected MCP server capabilities if type is mcpServerCapabilities. Exactly one nested block is allowed with the structure below. (see below for nested schema)
	...
	TargetMcpCapabilities *TargetMcpCapabilitiesInitParameters `json:"targetMcpCapabilities,omitempty" tf:"target_mcp_capabilities,omitempty"`
...
type AssertionObservation struct {
	...
	// (Block List, Max: 1) Expected MCP server capabilities if type is mcpServerCapabilities. Exactly one nested block is allowed with the structure below. (see below for nested schema)
	// Expected MCP server capabilities if `type` is `mcpServerCapabilities`. Exactly one nested block is allowed with the structure below.
	TargetMcpCapabilities *TargetMcpCapabilitiesObservation `json:"targetMcpCapabilities,omitempty" tf:"target_mcp_capabilities,omitempty"`
...
type AssertionParameters struct {
	...
	// Expected MCP server capabilities if `type` is `mcpServerCapabilities`. Exactly one nested block is allowed with the structure below.
	// +kubebuilder:validation:Optional
	TargetMcpCapabilities *TargetMcpCapabilitiesParameters `json:"targetMcpCapabilities,omitempty" tf:"target_mcp_capabilities,omitempty"`
...
type AssertionTargetMcpCapabilitiesInitParameters struct {

	// (List of String) List of MCP server capabilities to assert against.
...
type AssertionTargetMcpCapabilitiesObservation struct {
...
type AssertionTargetMcpCapabilitiesParameters struct {
...
type DragDropOptionsInitParameters struct {
	...
	// (Block List, Max: 1) Pixel offset from the center of the target element. (see below for nested schema)
	// Pixel offset from the center of the target element.
	Offset *OffsetInitParameters `json:"offset,omitempty" tf:"offset,omitempty"`
}

type DragDropOptionsObservation struct {
...
type DragDropOptionsParameters struct {
...
type OptionsListInitParameters struct {
	...
	// (Boolean) Capture HTTP request/response headers and bodies for Fetch/XHR calls made during browser tests.
	// Capture HTTP request/response headers and bodies for Fetch/XHR calls made during browser tests.
	CaptureNetworkPayloads *bool `json:"captureNetworkPayloads,omitempty" tf:"capture_network_payloads,omitempty"`
	...
	// (Boolean) Ignore server certificate error for SSL tests.
	// Ignore server certificate error for SSL tests.
	IgnoreCertificateValidation *bool `json:"ignoreCertificateValidation,omitempty" tf:"ignore_certificate_validation,omitempty"`
...
type ParamsInitParameters struct {
	...
	// (Block List, Max: 1) Options for a "drag" or "drop" step. (see below for nested schema)
	// Options for a "drag" or "drop" step.
	DragDropOptions *DragDropOptionsInitParameters `json:"dragDropOptions,omitempty" tf:"drag_drop_options,omitempty"`
...
type ParamsObservation struct {
	...
	// (Block List, Max: 1) Options for a "drag" or "drop" step. (see below for nested schema)
	// Options for a "drag" or "drop" step.
	DragDropOptions *DragDropOptionsObservation `json:"dragDropOptions,omitempty" tf:"drag_drop_options,omitempty"`
...
type ParamsParameters struct {
	...
	// Options for a "drag" or "drop" step.
	// +kubebuilder:validation:Optional
	DragDropOptions *DragDropOptionsParameters `json:"dragDropOptions,omitempty" tf:"drag_drop_options,omitempty"`
...
type RequestBasicauthInitParameters struct {
	...
	// (Boolean) Whether to inject the exp (expiration) claim automatically, for jwt authentication.
	// Whether to inject the `exp` (expiration) claim automatically, for `jwt` authentication.
	AddClaimsExp *bool `json:"addClaimsExp,omitempty" tf:"add_claims_exp,omitempty"`

	// (Boolean) Whether to inject the iat (issued at) claim automatically, for jwt authentication.
	// Whether to inject the `iat` (issued at) claim automatically, for `jwt` authentication.
	AddClaimsIat *bool `json:"addClaimsIat,omitempty" tf:"add_claims_iat,omitempty"`

	// (String) Algorithm to use for jwt authentication. Valid values are HS256, RS256, ES256.
	...
	// (String) JWT claims as a JSON string, for jwt authentication.
	...
	// (String, Sensitive) Signing key for jwt authentication. Use the shared secret for HS256 or the private key (PEM format) for RS256 and ES256.
	...
	// (String) Prefix added before the token in the Authorization header for jwt authentication. Defaults to Bearer.
...
type RequestDefinitionInitParameters struct {
	...
	// (String) The type of gRPC call to perform, or the MCP step call (init, tool_list, tool_call). Valid values are healthcheck, unary, init, tool_list, tool_call.
	...
	// (String) For MCP API steps, the MCP protocol version used by the request.
	// For MCP API steps, the MCP protocol version used by the request.
	McpProtocolVersion *string `json:"mcpProtocolVersion,omitempty" tf:"mcp_protocol_version,omitempty"`
	...
	// encoded arguments to pass to the tool when call_type is tool_call.
	// For MCP API steps, the JSON-encoded arguments to pass to the tool when `call_type` is `tool_call`.
	ToolArgs *string `json:"toolArgs,omitempty" tf:"tool_args,omitempty"`

	// (String) For MCP API steps, the name of the tool to call. Required when call_type is tool_call.
...
type TargetMcpCapabilitiesInitParameters struct {
...
type TargetMcpCapabilitiesObservation struct {
...
type TargetMcpCapabilitiesParameters struct {
...
type TestAssertionInitParameters struct {
	...
	// (Block List, Max: 1) Expected MCP server capabilities if type is mcpServerCapabilities. Exactly one nested block is allowed with the structure below. (see below for nested schema)
	// Expected MCP server capabilities if `type` is `mcpServerCapabilities`. Exactly one nested block is allowed with the structure below.
	TargetMcpCapabilities *AssertionTargetMcpCapabilitiesInitParameters `json:"targetMcpCapabilities,omitempty" tf:"target_mcp_capabilities,omitempty"`
...
type TestAssertionObservation struct {
	...
	// (Block List, Max: 1) Expected MCP server capabilities if type is mcpServerCapabilities. Exactly one nested block is allowed with the structure below. (see below for nested schema)
	// Expected MCP server capabilities if `type` is `mcpServerCapabilities`. Exactly one nested block is allowed with the structure below.
	TargetMcpCapabilities *AssertionTargetMcpCapabilitiesObservation `json:"targetMcpCapabilities,omitempty" tf:"target_mcp_capabilities,omitempty"`
...
type TestAssertionParameters struct {
	...
	// Expected MCP server capabilities if `type` is `mcpServerCapabilities`. Exactly one nested block is allowed with the structure below.
	// +kubebuilder:validation:Optional
	TargetMcpCapabilities *AssertionTargetMcpCapabilitiesParameters `json:"targetMcpCapabilities,omitempty" tf:"target_mcp_capabilities,omitempty"`
