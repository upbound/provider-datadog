...
type DefaultRuleInitParameters struct {
	...
	// (Block List) Cases of the rule, this is used to update notifications. (see below for nested schema)
	...
	// (Block List) Options on default rules. Note that only a subset of fields can be updated on default rule options. (see below for nested schema)
