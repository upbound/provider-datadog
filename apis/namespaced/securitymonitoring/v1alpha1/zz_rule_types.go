...
type ActionInitParameters struct {
	...
	// (Block List) Options on rules. (see below for nested schema)
...
type AnomalyDetectionOptionsInitParameters struct {
	...
	// (Number) An optional override baseline to apply while the rule is in the learning period. Value must be at least 0.
...
type CalculatedFieldInitParameters struct {
	...
	// (String) Expression. String length must be at least 1.
...
type ImpossibleTravelOptionsInitParameters struct {
	...
	// (Number) The duration in days during which Datadog learns a user's access locations before generating signals. Only applicable when baseline_user_locations is true. Defaults to 1 if unset. . Value must be between 1 and 30.
	...
	BaselineUserLocationsDuration *float64 `json:"baselineUserLocationsDuration,omitempty" tf:"baseline_user_locations_duration,omitempty"`
}
...
type NewValueOptionsInitParameters struct {
	...
	// (Number) The duration in days after which a learned value is forgotten. Accepted values are between 1 and 30. Value must be between 1 and 30.
...
type ReferenceTablesInitParameters struct {
	...
	// (String) The name of the column in the reference table. String length must be at least 1.
	...
	// (String) The field in the log that should be matched against the reference table. String length must be at least 1.
	...
	// (String) The name of the query to filter. String length must be at least 1.
	...
	// (String) The name of the reference table. String length must be at least 1.
...
type RuleInitParameters struct {
	...
	// (Block List) Cases for generating signals. (see below for nested schema)
	...
	// (Block List) Options for scheduled rules. When this field is present, the rule runs based on the schedule. When absent, it runs in real time on ingested logs. (see below for nested schema)
	...
	// defined tags for generated signals. See also effective_tags, which includes provider-level default_tags.
...
type RuleObservation struct {
	...
	// (Set of String) A list of tags for generated signals, including those inherited from the provider's default_tags configuration.
...
type RuleOptionsInitParameters struct {
	...
	// (Block List) Options for rules using the anomaly detection method. (see below for nested schema)
	...
	// (Block List) Options for rules using the impossible travel detection method. (see below for nested schema)
	...
	// (Number) Once a signal is generated, the signal will remain "open" if a case is matched at least once within this keep alive window (in seconds). Valid values are 0, 60, 300, 600, 900, 1800, 3600, 7200, 10800, 21600, 43200, 86400. Defaults to 3600.
	...
	// (Block List) New value rules specific options. (see below for nested schema)
	...
	// (Block List) Options for rules using the sequence detection method. (see below for nested schema)
...
type RuleQueryInitParameters struct {
	...
	// (Block List, Deprecated) Deprecated. It won't be applied anymore. (see below for nested schema)
	// **Deprecated**. It won't be applied anymore.
	...
	// (String) Source of events. Valid values are logs, audit, app_sec_spans, spans, security_runtime, network, events, security_signals. Defaults to "logs".
	...
	// (String, Deprecated) The target field to aggregate over when using the sum, max, or geo_data aggregations.
...
type ThirdPartyRuleOptionsParameters struct {
	...
	// Queries to be combined with third-party case queries. Each of them can have different group by fields, to aggregate differently based on the type of alert.
	// +kubebuilder:validation:Optional
	RootQuery []RootQueryParameters `json:"rootQuery,omitempty" tf:"root_query,omitempty"`
