...
type RetentionFilterOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/namespaced/apm.datadog/v1alpha1.RetentionFilter
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	FilterIds []*string `json:"filterIds,omitempty" tf:"filter_ids,omitempty"`

	// References to RetentionFilter in apm.datadog to populate filterIds.
	// +kubebuilder:validation:Optional
	FilterIdsRefs []v2.NamespacedReference `json:"filterIdsRefs,omitempty" tf:"-"`

	// Selector for a list of RetentionFilter in apm.datadog to populate filterIds.
	// +kubebuilder:validation:Optional
	FilterIdsSelector *v2.NamespacedSelector `json:"filterIdsSelector,omitempty" tf:"-"`
}
