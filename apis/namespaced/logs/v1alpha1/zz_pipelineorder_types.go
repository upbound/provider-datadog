...
type PipelineOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/namespaced/logs.datadog/v1alpha1.CustomPipeline
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	Pipelines []*string `json:"pipelines,omitempty" tf:"pipelines,omitempty"`

	// References to CustomPipeline in logs.datadog to populate pipelines.
	// +kubebuilder:validation:Optional
	PipelinesRefs []v2.NamespacedReference `json:"pipelinesRefs,omitempty" tf:"-"`

	// Selector for a list of CustomPipeline in logs.datadog to populate pipelines.
	// +kubebuilder:validation:Optional
	PipelinesSelector *v2.NamespacedSelector `json:"pipelinesSelector,omitempty" tf:"-"`
}
