...
type ArchiveOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/namespaced/logs.datadog/v1alpha1.Archive
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	ArchiveIds []*string `json:"archiveIds,omitempty" tf:"archive_ids,omitempty"`

	// References to Archive in logs.datadog to populate archiveIds.
	// +kubebuilder:validation:Optional
	ArchiveIdsRefs []v2.NamespacedReference `json:"archiveIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Archive in logs.datadog to populate archiveIds.
	// +kubebuilder:validation:Optional
	ArchiveIdsSelector *v2.NamespacedSelector `json:"archiveIdsSelector,omitempty" tf:"-"`
}
