...
type IndexOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/namespaced/logs.datadog/v1alpha1.Index
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	Indexes []*string `json:"indexes,omitempty" tf:"indexes,omitempty"`

	// References to Index in logs.datadog to populate indexes.
	// +kubebuilder:validation:Optional
	IndexesRefs []v2.NamespacedReference `json:"indexesRefs,omitempty" tf:"-"`

	// Selector for a list of Index in logs.datadog to populate indexes.
	// +kubebuilder:validation:Optional
	IndexesSelector *v2.NamespacedSelector `json:"indexesSelector,omitempty" tf:"-"`
