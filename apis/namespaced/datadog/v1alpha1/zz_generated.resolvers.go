...
func (mg *OrgGroupMembership) ResolveReferences( // ResolveReferences of this OrgGroupMembership.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("datadog.m.upbound.io", "v1alpha1", "OrgGroup", "OrgGroupList")
		if err != nil {
...
func (mg *OrgGroupPolicyOverride) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.OrgGroupIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("datadog.m.upbound.io", "v1alpha1", "OrgGroupPolicy", "OrgGroupPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *RUMExclusionFilter) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("datadog.m.upbound.io", "v1alpha1", "RUMApplication", "RUMApplicationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *SLOCorrection) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("datadog.m.upbound.io", "v1alpha1", "ServiceLevelObjective", "ServiceLevelObjectiveList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *SecureEmbedDashboard) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("datadog.m.upbound.io", "v1alpha1", "DashboardJSON", "DashboardJSONList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *ServiceAccessToken) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("datadog.m.upbound.io", "v1alpha1", "ServiceAccount", "ServiceAccountList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *TeamConnection) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.Team != nil {
		{
			m, l, err = apisresolver.GetManagedResource("datadog.m.upbound.io", "v1alpha1", "Team", "TeamList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
