...
type CountInitParameters struct {
	...
	// (String) The formula that specifies how to compute the bad events. Mutually exclusive with total_events_formula.
	// The formula that specifies how to compute the bad events. Mutually exclusive with `total_events_formula`.
	BadEventsFormula *string `json:"badEventsFormula,omitempty" tf:"bad_events_formula,omitempty"`
	...
	// (String) The formula that specifies how to compute the total events. Mutually exclusive with bad_events_formula.
...
type SliSpecificationInitParameters struct {
	...
	// based (metric) SLI specification. Composed of a good events formula, either a total events formula or a bad events formula (but not both), and the underlying metric queries. (see below for nested schema)
