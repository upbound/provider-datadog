...
type FastlyServiceInitParameters struct {
	...
	// Fastly Account id.
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/namespaced/integration.datadog/v1alpha1.FastlyAccount
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	AccountID *string `json:"accountId,omitempty" tf:"account_id,omitempty"`

	// Reference to a FastlyAccount in integration.datadog to populate accountId.
	// +kubebuilder:validation:Optional
	AccountIDRef *v2.NamespacedReference `json:"accountIdRef,omitempty" tf:"-"`

	// Selector for a FastlyAccount in integration.datadog to populate accountId.
	// +kubebuilder:validation:Optional
...
func init() {
	SchemeBuilder.Register(&FastlyService{}, &FastlyServiceList{})
}
