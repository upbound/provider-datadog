...
func (mg *GCPSTS) GetTerraformResourceType() string {
	return "datadog_integration_gcp_sts"
}
...
// LateInitialize this GCPSTS using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GCPSTS) LateInitialize(attrs []byte) (bool, error) {
	params := &GCPSTSParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
	opts = append(opts, resource.WithNameFilter("MetricNamespaceConfigs"))
	opts = append(opts, resource.WithNameFilter("MonitoredResourceConfigs"))
