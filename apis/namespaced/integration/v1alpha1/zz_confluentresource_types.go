...
type ConfluentResourceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/namespaced/integration.datadog/v1alpha1.ConfluentAccount
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	AccountID *string `json:"accountId,omitempty" tf:"account_id,omitempty"`

	// Reference to a ConfluentAccount in integration.datadog to populate accountId.
	// +kubebuilder:validation:Optional
	AccountIDRef *v2.NamespacedReference `json:"accountIdRef,omitempty" tf:"-"`

	// Selector for a ConfluentAccount in integration.datadog to populate accountId.
	// +kubebuilder:validation:Optional
