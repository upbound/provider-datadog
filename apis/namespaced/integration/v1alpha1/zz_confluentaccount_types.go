...
type ConfluentAccountInitParameters struct {
	...
	APISecretSecretRef v2.LocalSecretKeySelector `json:"apiSecretSecretRef" tf:"-"`
...
// ConfluentAccount is the Schema for the ConfluentAccounts API. Provides a Datadog IntegrationConfluentAccount resource. This can be used to create and manage Datadog integration_confluent_account.
