...
type FastlyAccountInitParameters struct {
	...
	// (String, Sensitive) The API key for the Fastly account. Exactly one of api_key or api_key_wo must be set.
...
// FastlyAccount is the Schema for the FastlyAccounts API. Provides a Datadog IntegrationFastlyAccount resource. This can be used to create and manage Datadog integration_fastly_account.
