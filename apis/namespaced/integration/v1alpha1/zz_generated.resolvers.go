...
func (mg *ConfluentResource) ResolveReferences( // ResolveReferences of this ConfluentResource.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("integration.datadog.datadog.m.upbound.io", "v1alpha1", "ConfluentAccount", "ConfluentAccountList")
		if err != nil {
...
func (mg *FastlyService) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("integration.datadog.datadog.m.upbound.io", "v1alpha1", "FastlyAccount", "FastlyAccountList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
