...
type ProviderConfigSpec struct {
	// ReconciliationPolicy configures how the managed resources referencing
	// this ProviderConfig are reconciled, for example the retry backoff.
	// +optional
...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,datadog}
...
// A ClusterProviderConfig configures a Datadog provider.
// +kubebuilder:subresource:status
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="SECRET-NAME",type="string",JSONPath=".spec.credentials.secretRef.name",priority=1
