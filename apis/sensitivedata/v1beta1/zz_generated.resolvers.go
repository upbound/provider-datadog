...
// ResolveReferences of this ScannerRule.
func (mg *ScannerRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &ScannerGroupList{},
			Managed: &ScannerGroup{},
		},
	})
	if err != nil {
