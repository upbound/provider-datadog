...
func (tr *Test) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"api_step[*].request_basicauth[*].access_key": "apiStep[*].requestBasicauth[*].accessKeySecretRef", "api_step[*].request_basicauth[*].client_secret": "apiStep[*].requestBasicauth[*].clientSecretSecretRef", "api_step[*].request_basicauth[*].password": "apiStep[*].requestBasicauth[*].passwordSecretRef", "api_step[*].request_basicauth[*].secret": "apiStep[*].requestBasicauth[*].secretSecretRef", "api_step[*].request_basicauth[*].secret_key": "apiStep[*].requestBasicauth[*].secretKeySecretRef", "api_step[*].request_client_certificate[*].cert[*].content": "apiStep[*].requestClientCertificate[*].cert[*].contentSecretRef", "api_step[*].request_client_certificate[*].key[*].content": "apiStep[*].requestClientCertificate[*].key[*].contentSecretRef", "request_basicauth[*].access_key": "requestBasicauth[*].accessKeySecretRef", "request_basicauth[*].client_secret": "requestBasicauth[*].clientSecretSecretRef", "request_basicauth[*].password": "requestBasicauth[*].passwordSecretRef", "request_basicauth[*].secret": "requestBasicauth[*].secretSecretRef", "request_basicauth[*].secret_key": "requestBasicauth[*].secretKeySecretRef", "request_client_certificate[*].cert[*].content": "requestClientCertificate[*].cert[*].contentSecretRef", "request_client_certificate[*].key[*].content": "requestClientCertificate[*].key[*].contentSecretRef"}
}
