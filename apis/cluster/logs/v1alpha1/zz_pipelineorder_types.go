...
type PipelineOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/cluster/logs.datadog/v1alpha1.CustomPipeline
	...
	PipelinesRefs []v2.Reference `json:"pipelinesRefs,omitempty" tf:"-"`

	// Selector for a list of CustomPipeline in logs.datadog to populate pipelines.
	// +kubebuilder:validation:Optional
	PipelinesSelector *v2.Selector `json:"pipelinesSelector,omitempty" tf:"-"`
}
