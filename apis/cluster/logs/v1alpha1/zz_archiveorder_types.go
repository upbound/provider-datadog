...
type ArchiveOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/cluster/logs.datadog/v1alpha1.Archive
	...
	ArchiveIdsRefs []v2.Reference `json:"archiveIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Archive in logs.datadog to populate archiveIds.
	// +kubebuilder:validation:Optional
	ArchiveIdsSelector *v2.Selector `json:"archiveIdsSelector,omitempty" tf:"-"`
}
