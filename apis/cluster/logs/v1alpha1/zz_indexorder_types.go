...
type IndexOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/cluster/logs.datadog/v1alpha1.Index
	...
	IndexesRefs []v2.Reference `json:"indexesRefs,omitempty" tf:"-"`

	// Selector for a list of Index in logs.datadog to populate indexes.
	// +kubebuilder:validation:Optional
	IndexesSelector *v2.Selector `json:"indexesSelector,omitempty" tf:"-"`
