...
type SettingsInitParameters_2 struct {
	...
	Settings *SettingsSettingsInitParameters `json:"settings,omitempty" tf:"settings,omitempty"`
}
...
type SettingsObservation_2 struct {
	...
	// (Block List, Max: 1) Organization settings (see below for nested schema)
	// Organization settings
	Settings *SettingsSettingsObservation `json:"settings,omitempty" tf:"settings,omitempty"`
}
...
type SettingsSettingsInitParameters struct {
...
// Settings is the Schema for the Settingss API. Provides a Datadog Organization resource. This can be used to manage your Datadog organization's settings.
