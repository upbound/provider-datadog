...
func (mg *WorkloadSecurityAgentRule) GetTerraformResourceType() string {
	return "datadog_cloud_workload_security_agent_rule"
}
...
// LateInitialize this WorkloadSecurityAgentRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *WorkloadSecurityAgentRule) LateInitialize(attrs []byte) (bool, error) {
	params := &WorkloadSecurityAgentRuleParameters{}
