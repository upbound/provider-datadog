...
func (mg *OpsgenieServiceObject) GetTerraformResourceType() string {
	return "datadog_integration_opsgenie_service_object"
}
...
func (tr *OpsgenieServiceObject) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"opsgenie_api_key": "spec.forProvider.opsgenieApiKeySecretRef"}
}
...
// LateInitialize this OpsgenieServiceObject using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *OpsgenieServiceObject) LateInitialize(attrs []byte) (bool, error) {
	params := &OpsgenieServiceObjectParameters{}
