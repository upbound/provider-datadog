...
type FastlyServiceInitParameters struct {
	...
	// Fastly Account id.
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/integration/v1beta1.FastlyAccount
	AccountID *string `json:"accountId,omitempty" tf:"account_id,omitempty"`

	// Reference to a FastlyAccount in integration to populate accountId.
	// +kubebuilder:validation:Optional
	AccountIDRef *v1.Reference `json:"accountIdRef,omitempty" tf:"-"`

	// Selector for a FastlyAccount in integration to populate accountId.
	// +kubebuilder:validation:Optional
