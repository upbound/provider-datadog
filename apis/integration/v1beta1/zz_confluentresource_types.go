...
type ConfluentResourceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/integration/v1beta1.ConfluentAccount
	AccountID *string `json:"accountId,omitempty" tf:"account_id,omitempty"`

	// Reference to a ConfluentAccount in integration to populate accountId.
	// +kubebuilder:validation:Optional
	AccountIDRef *v1.Reference `json:"accountIdRef,omitempty" tf:"-"`

	// Selector for a ConfluentAccount in integration to populate accountId.
	// +kubebuilder:validation:Optional
