...
type AssertionInitParameters struct {
	...
	// (String) Synthetics test type. Valid values are api, browser, mobile.
...
type MonitorOptionsInitParameters struct {
	...
	// (String) The name of the preset for the notification for the monitor. Valid values are show_all, hide_all, hide_query, hide_handles.
...
type TestInitParameters struct {
	...
	// step api tests (see below for nested schema)
