...
type RetentionFilterOrderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-datadog/apis/apm/v1beta1.RetentionFilter
	FilterIds []*string `json:"filterIds,omitempty" tf:"filter_ids,omitempty"`

	// References to RetentionFilter in apm to populate filterIds.
	// +kubebuilder:validation:Optional
	FilterIdsRefs []v1.Reference `json:"filterIdsRefs,omitempty" tf:"-"`

	// Selector for a list of RetentionFilter in apm to populate filterIds.
	// +kubebuilder:validation:Optional
