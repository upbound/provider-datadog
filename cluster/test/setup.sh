...
${KUBECTL} -n upbound-system create secret generic example-secret --from-literal=example-key=example-value --from-literal=example-uuid-key=9c2b6a1e-4d3f-4b8a-9e2c-7f1d0a5b3c6e --dry-run=client -o yaml | ${KUBECTL} apply -f -
